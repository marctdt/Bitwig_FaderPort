...
function onMidi(status, data1, data2)
{
	...
	if (isNoteOn(status)) 
	{
			...
			switch (data1)
			{
               ...
               else
               {
                ...
                case APPLICATION.UNDO:
					application.undo();
					sendNoteOn(0, APPLICATION.UNDO, 127);
                    break;
            ...
            case APPLICATION.ENTER:
               ...
               break;
                case APPLICATION.TOGGLE_NOTE_EDITOR:
                    ...
                    //var paneli = panelLayout.indexOf(application.panelLayout())+1;
                    
                   // if (i > 2) {
                    //    i = 0;
                    //}
                    //host.println(panelLayout[paneli]);
                    //application.setPanelLayout(panelLayout[paneli]);
		...
		else if (data2 == 0) // Check button release, no press
		{
			...
			{
				case APPLICATION.UNDO:
                    sendNoteOn(0, APPLICATION.UNDO, 0);
					break;
			}
		}
